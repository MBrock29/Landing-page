...
export default function Contact() {
    return (
        <div className="contact">
            ...
            <div><p><a href="https://www.linkedin.com/in/michael-brock-48909998/" target="_blank" rel="noreferrer">Click here!</a></p></div></div>
            <div className="contactCard"><div className="contactTitle">GitHub&nbsp;<GitHubIcon /></div>
            <div><p><a href="https://github.com/MBrock29" target="_blank" rel="noreferrer">Click here!</a></p></div></div>
            </div>
        </div>
    )
}
